...
// 
    ...
    function showSuggestions(artistName) {
        ...
        // Update the URL to point to your PHP script
        const apiFetchLink = `https://luker1.sgedu.site/ticketfinder/getSuggestions.php?query=${encodeURIComponent(artistName)}`;
